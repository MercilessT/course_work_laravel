...
<head>
    ...
    <title>Прийняті</title>
</head>
<body>
<div class="main-text">Прийняті</div>
<div class="links">
    <a href="{{ URL('reject') }}">Відхилені</a>
...
@foreach($accepts as $accept)
    @if($loop->iteration % 2 === 0)
        <div class="registrations-odd">
            {{ $loop->iteration }}.
            <span class="name">{{ $accept->name }}</span>
            <span class="phone">{{ $accept->phone_number }}</span>
